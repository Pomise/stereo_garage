...
#define   Fixture_Front_Limit   22
#define   Fixture_Back_Limit    24
/*****************************夹具电机舵机引脚定位******************************/
#define   Fixture_Motor_1  A4
#define   Fixture_Motor_2  A5
...
#define   Servo_PIN     9
#define   Fixture_Front_Limit   A2
#define   Fixture_Back_Limit    A3
